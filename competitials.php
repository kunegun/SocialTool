...
// ARRAY de marcas
    ...
    $competitials["Brugal_fb_int"] = array ("brugaltitanium","fundacionbrugal","brugalUSA","premiosbrugal","brugalchile","brugal-UK","brugalrussia");
    $competitials["Brugal_fb_int_comp"] = array ("smirnoffice","jackdaniels","martini","baileys","belvederevodka","absolutus","jimbeam");
    $competitials["Brugal_tw"] = array ("RonBrugal_ES","RonBarceloSpain","RonBarceloRD","BSapphire_ES","RonCaciqueVe","absolutvodka_us","BrugalUK","RonBrugalRD","BrugalUSA","Ron_Cartavio","RonNegrita","BacardiSpain","ronlegendario","ronsantateresa","bacardi","ronmatusalem_es","ronalmirante_","Bombay_Spain","HavanaClubMx","Beefeaterdrygin");
    $competitials["Brugal_tw_int"] = array ("Smirnoff","JackHoney","MartiniRoyaleUK","Martini_Tweets","BaileysOriginal","belvederevodka","jimbeamofficial");
    $competitials["Brugal_instagram"] = array (12376836,181692521,104868834,259554463,300961621,2290918,5311574,1533012,1425022,342690122,379788111,305419893,343706875);
    $competitials["Cervezas_fb"] = array ("mahou.es","EstrellaDamm","heineken","amstel.es","sanmiguel","budweiserspain","estrellagalicia","cruzcampo.es","coronita");
    $competitials["Cervezas_tw"] = array ("mahou_es","EstrellaDammCat","Heineken_ES","amstel_ES","Budweiser","estrellagalicia","Cruzcampo","escoronita");
    $competitials["Brugal_suspiro_fb"] = array ("brugalsuspiroterapia","BudLight","coorslight","coronalightUSA","limonynadaespana","CocaCola.Zero.Espana","nesteaeurope","smoda.es","mujerhoycom","vogueespana","telva.com");
